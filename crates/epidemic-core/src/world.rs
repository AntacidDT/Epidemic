...
impl World {
    ...
    fn get_neighbor_pairs(&self) -> Vec<(u16, u16)> {
        vec![
            ...
            (4, 8), (5, 8), (5, 6),
            // South America
            (6, 7), (6, 8), (6, 11), (8, 9), (9, 11),
            // North Atlantic
            (1, 12), (12, 13), (12, 14),
            // Western Europe
            (14, 15), (15, 16), (16, 17), (14, 18), (15, 18),
            (14, 19), (15, 19), (19, 20), (15, 22),
            // Northern Europe
            (12, 21), (15, 21), (21, 37),
            // Central Europe
            ...
            (26, 32), (18, 29), (22, 27),
            // Eastern Europe
            (23, 33), (33, 34), (34, 35), (33, 36), (34, 36),
            // Russia
            (23, 37), (36, 37), (34, 37), (37, 38),
            // Caucasus
            (37, 38), (38, 39),
            // Middle East
            ...
            // East Africa
            (44, 51), (51, 52), (52, 53), (53, 54), (54, 55),
            // Central Africa
            (50, 56), (56, 57), (57, 58), (55, 56),
            // Southern Africa
            (57, 58), (58, 59),
            // Central Asia
            (37, 60), (60, 61), (61, 62),
            ...
            // East Asia
            (37, 74), (74, 75), (74, 76), (76, 77), (74, 78), (74, 79),
            (67, 74), (73, 67),
            // Oceania
            (67, 80), (80, 81), (80, 82), (67, 82),
        ]
    }
